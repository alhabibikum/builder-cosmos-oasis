export default function About() {
  return (
    <section className="prose prose-slate max-w-none dark:prose-invert">
      ...
      <h2>Craftsmanship</h2>
      <p>
        We partner with skilled ateliers across the region and carefully source
        materials to ensure durability and drape. Every stitch is inspected for
        perfection.
      </p>
      <h2>Values</h2>
      <ul>
        <li>Premium quality and ethical production</li>
        <li>Inclusive sizing and comfortable fits</li>
