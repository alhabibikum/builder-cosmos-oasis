...
export default function OrderConfirmation() {
  ...
  return (
    <section className="mx-auto max-w-xl py-16 text-center">
      <div className="font-['Playfair Display'] text-3xl font-extrabold tracking-tight">
        Thank you for your order
      </div>
      <p className="mt-2 text-muted-foreground">
        Your order{" "}
        <span className="font-semibold text-foreground">{orderId}</span> has
        been placed successfully. You will receive a confirmation email shortly.
      </p>
      {pay && (
