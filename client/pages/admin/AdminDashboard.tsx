...
export default function AdminDashboard() {
  ...
  return (
    <section className="space-y-6">
      <h1 className="font-['Playfair Display'] text-3xl font-extrabold tracking-tight">Admin Dashboard</h1>
        ...
        <div className="divide-y">
          {orders.map((o, idx) => (
            <div key={o.id} className="grid gap-3 p-4 md:grid-cols-7 md:items-center">
              ...
              <div className="text-sm">{o.items[0]?.product.title} {o.items.length > 1 ? `+${o.items.length - 1} more` : ""}</div>
              ...
              <div className="text-right">
                <a className="text-sm text-primary underline" href="#" onClick={(e) => { e.preventDefault(); alert(JSON.stringify(o, null, 2)); }}>View</a>
              </div>
            </div>
          ))}
