...
export default function AdminSidebarLayout({
  ...
  return (
    <Tabs value={tab} onValueChange={setTab} orientation="vertical" className="grid gap-6 md:gap-8 lg:grid-cols-5">
      <aside className="lg:col-span-1">
        <div className="block lg:hidden mb-6">
          <label className="block text-xs font-semibold text-foreground mb-3 uppercase tracking-wide">Quick Navigation</label>
          <select
